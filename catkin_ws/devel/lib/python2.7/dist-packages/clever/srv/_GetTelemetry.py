...
"""autogenerated by genpy from clever/GetTelemetryRequest.msg. Do not edit."""
import sys
...
class GetTelemetryRequest(genpy.Message):
  ...
  _type = "clever/GetTelemetryRequest"
...
def _get_struct_I():
    ...
    return _struct_I
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from clever/GetTelemetryResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class GetTelemetryResponse(genpy.Message):
  ...
  _type = "clever/GetTelemetryResponse"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """string frame_id
bool connected
bool armed
