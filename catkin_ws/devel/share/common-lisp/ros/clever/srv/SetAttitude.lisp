...
(cl:defmethod cl:initialize-instance :after ((m <SetAttitude-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetAttitude-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name clever-srv:<SetAttitude-request> is deprecated: use clever-srv:SetAttitude-request instead.")))
...
(cl:defmethod thrust-val ((m <SetAttitude-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clever-srv:thrust-val is deprecated.  Use clever-srv:thrust instead.")
  (thrust m))
...
(cl:defmethod cl:initialize-instance :after ((m <SetAttitude-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetAttitude-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name clever-srv:<SetAttitude-response> is deprecated: use clever-srv:SetAttitude-response instead.")))
