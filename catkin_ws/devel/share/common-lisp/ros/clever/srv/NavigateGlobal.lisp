...
(cl:defmethod cl:initialize-instance :after ((m <NavigateGlobal-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'NavigateGlobal-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name clever-srv:<NavigateGlobal-request> is deprecated: use clever-srv:NavigateGlobal-request instead.")))
...
(cl:defmethod speed-val ((m <NavigateGlobal-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clever-srv:speed-val is deprecated.  Use clever-srv:speed instead.")
  (speed m))
...
(cl:defmethod auto_arm-val ((m <NavigateGlobal-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clever-srv:auto_arm-val is deprecated.  Use clever-srv:auto_arm instead.")
  (auto_arm m))
...
(cl:defmethod cl:initialize-instance :after ((m <NavigateGlobal-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'NavigateGlobal-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name clever-srv:<NavigateGlobal-response> is deprecated: use clever-srv:NavigateGlobal-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <NavigateGlobal-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clever-srv:success-val is deprecated.  Use clever-srv:success instead.")
  (success m))

(cl:ensure-generic-function 'message-val :lambda-list '(m))
(cl:defmethod message-val ((m <NavigateGlobal-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clever-srv:message-val is deprecated.  Use clever-srv:message instead.")
  (message m))
